...
scanInterval = 600 # in seconds : duration between each scan+parse+dbwrite process call
...
scanTime = 15 # in seconds : duration for which ble devices are scanned each time parseAdv is called

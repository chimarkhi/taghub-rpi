...
scanInterval = 60 # in seconds : duration between each scan+parse+dbwrite process call
scanSleepTime = 20 # in seconds: unused 
uploadInterval = 10 # in seconds : duration between each dbtoserver upload proceess call

...
def createDB():
	...
	# Humidity table
                ...
                cur.execute("""CREATE TABLE IF NOT EXISTS HumidData 
                (seq INTEGER PRIMARY KEY AUTOINCREMENT, 
                NdId TEXT NOT NULL, 
                Hum REAL, 
                NdTs TEXT, 
	...
	# Probe table
                ...
                cur.execute("""CREATE TABLE IF NOT EXISTS ProbeData \
                (seq INTEGER PRIMARY KEY AUTOINCREMENT, \
                NdId TEXT NOT NULL, \
                Prb1 REAL, \
                Prb2 REAL, \
...
def uploadPayload():
	...
	if rowId != None:
		try:
			r = requests.post(GatewayParams.DATA_LINK,json=payload, headers=GatewayParams.POST_HEADERS,timeout=GatewayParams.POST_TIMEOUT)
			if r != None:
